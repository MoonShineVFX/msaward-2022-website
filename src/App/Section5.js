  ...
  return (
    <div className='w-9/12 text-white mx-auto w-full flex flex-col justify-center items-center  relative mt-64'>
      <div className='flex w-3/5 justify-between items-center mb-16'>
        <div className='text-4xl font-bold'>夢想 × ROG <spqn className='text-red-600'>MAX</spqn>！禮物軍團</div>
        <div className='w-24'>
      ...
      <div className='w-full my-6'>
        <div className='w-3/5 bg-[#ffffff04] rounded-sm p-6 ml-auto relative h-56 mb-32'>
            <div className='w-28'>
        ...
        <div className='w-3/5 bg-[#ffffff04] rounded-sm p-6 mr-auto relative h-56 mb-32'>
            <div className='w-28'>
              <img src={process.env.PUBLIC_URL+'/images/b.png'} alt="" />
            </div>
            
            <div className='text-sm text-zinc-400 mt-10'>ROG Delta S 電競耳麥 (價值 $5,890)</div>
            <div className='w-2/5 absolute top-4 right-0'>
        ...
        <div className='w-3/5 bg-[#ffffff04] rounded-sm p-6 ml-auto relative h-56 mb-32'>
            ...
            <div className='text-sm text-zinc-400 mt-10'>ROG Delta S 電競耳麥 (價值 $5,890)</div>
            <div className='w-3/5 absolute top-4 -right-16'>
